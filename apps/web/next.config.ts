    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=31536000; includeSubDomains; preload" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.learnly.app https://*.clerk.accounts.dev https://js.stripe.com https://*.posthog.com https://*.i.posthog.com https://challenges.cloudflare.com",
              ...
              "connect-src 'self' http://localhost:8000 http://127.0.0.1:8000 http://localhost:9000 http://127.0.0.1:9000 https://*.clerk.accounts.dev https://api.stripe.com https://clerk.learnly.app https://clerk-telemetry.com https://*.posthog.com https://*.i.posthog.com https://challenges.cloudflare.com wss: ws:",
