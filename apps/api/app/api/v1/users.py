...
@router.post("/me/become-instructor", status_code=status.HTTP_410_GONE)
async def become_instructor_deprecated() -> dict[str, str]:
    raise HTTPException(
        status_code=status.HTTP_410_GONE,
        detail="Use POST /api/v1/instructor-applications to apply",
    )
